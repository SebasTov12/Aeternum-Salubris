...
const AppState = {
            ...
            this.tramites = [
                {
                    ...
                    historial: [
                        ...
                        {
                            etapa: 'Verificación de Documentación Básica',
                            fecha: new Date('2024-11-02').toISOString(),
                            descripcion: 'Revisión de documentos legales: Certificado de Cámara de Comercio, RUT, Concepto de Uso de Suelo',
                            inspector: 'inspector@demo.com',
                            notas: 'Documentación básica verificada',
                            completado: true
                        },
                        {
                            etapa: 'Verificación de Condiciones Sanitarias',
                            fecha: new Date('2024-11-03').toISOString(),
                            descripcion: 'Verificación de limpieza, ventilación, iluminación, agua potable, control de plagas y manejo de residuos',
                            inspector: 'inspector@demo.com',
                            notas: 'Condiciones sanitarias verificadas',
                            completado: true
                        },
                        {
                            etapa: 'Verificación de Buenas Prácticas de Manufactura (BPM)',
                            fecha: new Date('2024-11-05').toISOString(),
                            descripcion: 'Verificación de control de temperaturas, almacenamiento, manipulación higiénica, equipos desinfectados y carné de salud de empleados',
                            inspector: 'inspector@demo.com',
                            notas: 'Se encontraron algunas áreas de mejora en el almacenamiento de alimentos',
                            completado: true
                        },
                        {
                            etapa: 'Primera Visita de Inspección Sanitaria',
                            fecha: null,
                            descripcion: 'Inspección física del establecimiento por inspector sanitario de la Secretaría de Salud',
                            inspector: null,
                            notas: '',
                            completado: false
                        },
                        {
                            etapa: 'Revisión y Evaluación',
                            fecha: null,
                            descripcion: 'Evaluación del cumplimiento de normas sanitarias (Decreto 3075 de 1997 y Resolución 2674 de 2013)',
                            inspector: null,
                            notas: '',
                            completado: false
                        },
                        {
                            etapa: 'Segunda Visita (Corrección de Requerimientos)',
                            fecha: null,
                            descripcion: 'Si hubo requerimientos, verificación de correcciones realizadas por el establecimiento',
                            inspector: null,
                            notas: '',
                            completado: false
                        },
                        {
                            etapa: 'Emisión de Concepto Sanitario',
                            fecha: null,
                            descripcion: 'Emisión del resultado final: Favorable, Favorable con requerimientos, o Desfavorable',
                            inspector: null,
                            notas: '',
                            completado: false
                        }
                ...
                },
                {
                    id: 'TRM-002',
                    comercioId: 'comercio@demo.com',
                    nombreComercio: 'Panadería La Delicia',
    ...
    copyCredentials(email, password) {
        ...
        if (loginEmail && loginPassword) {
            ...
            this.showNotification('Credenciales cargadas automáticamente', 'info');
        }
    },
            ...
            <div class="notifications-container">
                ...
                ${filteredNotifications.length === 0 ? `
                    <div class="empty-state">
                        ...
                        <p>${currentFilter === 'unread' ? 'No tienes notificaciones sin leer' : currentFilter === 'read' ? 'No tienes notificaciones leídas' : 'Aún no has recibido notificaciones'}</p>
                    </div>
                ` : `
                                    ...
                                    <div class="notification-content">
                                        ...
                                        <div class="notification-footer">
                                            ...
                                            <div class="notification-actions">
                                                ${!notif.read ? `
                                                    <button class="btn-icon-small" onclick="AppState.markNotificationReadById('${notif.id}')" title="Marcar como leída">
                                                        ✓
                                                    </button>
                                                ` : ''}
                ...
                <div class="profile-sections">
                        ...
                        <form id="profileFormSection">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="profileDireccionSection" value="${user.direccion || ''}" placeholder="Dirección del comercio">
                                </div>
                                ` : `
                                <div class="form-group">
                                    <label>Número de Identificación</label>
                                    <input type="text" id="profileIdentificacionSection" value="${user.identificacion || ''}" placeholder="Cédula o documento">
                                </div>
                                `}
                            </div>
                            ${user.tipo === 'comercio' ? `
                    ...
                    <div class="profile-card">
                        ...
                        <form id="passwordFormSection">
                            <div class="form-group">
                                ...
                                <input type="password" id="oldPasswordSection" placeholder="Ingresa tu contraseña actual">
                                <small class="form-help">Dejar vacío si no deseas cambiar la contraseña</small>
                            </div>
                            <div class="form-group">
                                <label>Nueva Contraseña</label>
                                <input type="password" id="newPasswordSection" placeholder="Mínimo 6 caracteres">
                            </div>
                            <div class="form-group">
                                <label>Confirmar Nueva Contraseña</label>
                                <input type="password" id="confirmPasswordSection" placeholder="Repite la nueva contraseña">
                            </div>
                            <div class="form-actions">
                    ...
                    <div class="profile-card">
                        ...
                        <div class="profile-stats">
                            ${user.tipo === 'comercio' ? `
                            <div class="stat-item">
                                <span class="stat-label">Trámites Totales</span>
                            ...
                            ` : `
                            <div class="stat-item">
                                <span class="stat-label">Trámites Asignados</span>
    ...
    updatePasswordFromSection() {
        ...
        if (!oldPassword && !newPassword && !confirmPassword) {
            this.showNotification('No se realizaron cambios en la contraseña', 'info');
            return;
        }
        
        if (!oldPassword || !newPassword || !confirmPassword) {
            this.showNotification('Por favor completa todos los campos para cambiar la contraseña', 'error');
            return;
        }
        
        if (oldPassword !== this.currentUser.password && oldPassword !== 'demo123') {
            this.showNotification('La contraseña actual no es correcta', 'error');
            return;
        }
    ...
    renderStatsSection() {
        ...
        // Estadísticas por tipo de comercio
        const tiposComercio = {};
        ...
        container.innerHTML = `
            <div class="stats-container">
                ...
                <div class="stats-grid-enhanced">
                    ...
                    <div class="stat-card-enhanced tiempo">
                        ...
                        <div class="stat-info">
                            ...
                            <span class="stat-subtitle">Días para completar</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="charts-grid">
                    <div class="chart-card">
                        <h3>Trámites por Tipo de Comercio</h3>
                        <div class="chart-container-enhanced">
                    ...
                    <div class="chart-card">
                        ...
                        <div class="activity-summary">
                            <div class="activity-item">
                                <span class="activity-label">Tasa de Éxito</span>
    ...
    updateStatsPeriod() {
        // Esta función se puede expandir para filtrar por período
        this.renderStatsSection();
    },
    ...
    renderCalendarSection() {
        ...
        container.innerHTML = `
            <div class="calendar-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <button id="prevMonthSection" class="btn btn-secondary">←</button>
                <h3 id="currentMonthSection"></h3>
                <button id="nextMonthSection" class="btn btn-secondary">→</button>
            </div>
        ...
        return `
            <div class="tramite-card ${tramite.estado}" data-id="${tramite.id}">
                ...
                <div class="tramite-info">
                    ...
                    <p>Dirección: ${tramite.direccion}</p>
                    <p>Tipo: ${this.getTipoComercioLabel(tramite.tipoComercio)}</p>
                    <p>Teléfono: ${tramite.telefono}</p>
                </div>
    ...
    showTramiteDetail(tramiteId, userType) {
                ...
                actionsHTML = `
                    <div class="inspector-actions">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="inspectorNotas" placeholder="Ingrese notas sobre la visita o revisión..." rows="4"></textarea>
                        </div>
        ...
        const detailActions = `
            <div class="detail-actions">
                ...
                <button class="btn btn-primary btn-sm" onclick="AppState.showMapModal('${tramiteId}')">Ver Ubicación</button>
                ...
                ${tramite.documentosRequeridos.map(doc => `
                    <div class="checklist-item ${doc.subido ? 'completed' : ''}">
                        <div class="checklist-content">
                            <span class="checklist-icon">${doc.subido ? '✓' : '○'}</span>
                            <div>
        ...
        content.innerHTML = `
            <h2>Detalle del Trámite: ${tramite.id}</h2>
            <div class="tramite-info">
                <h3>${tramite.nombreComercio}</h3>
    ...
    exportarTramitePDF(tramiteId) {
        ...
        const contenido = `
            ...
            DIRECCIÓN: ${tramite.direccion}
            ESTADO: ${this.getEstadoLabel(tramite.estado)}
            FECHA CREACIÓN: ${new Date(tramite.fechaCreacion).toLocaleString('es-CO')}
        ...
        a.click();
        this.showNotification('Trámite exportado', 'success');
    },
    ...
    completarEtapa(tramiteId) {
        ...
        // Si es la última etapa, completar el trámite
    ...
    finalizarTramite(tramiteId, resultado) {
        ...
        const etapaEmision = tramite.historial.find(h => h.etapa === 'Emisión de Concepto Sanitario');
        if (etapaEmision) {
    ...
    getDocumentosRequeridos(tipoComercio) {
        const documentosBasicos = [
            { nombre: 'Certificado de Existencia y Representación Legal', requerido: true, categoria: 'legal' },
            { nombre: 'Registro Único Tributario (RUT)', requerido: true, categoria: 'legal' },
            { nombre: 'Concepto de Uso de Suelo', requerido: true, categoria: 'legal' },
            { nombre: 'Certificado de Fumigación o Control de Plagas', requerido: true, categoria: 'sanitario' },
            { nombre: 'Análisis de Agua Potable', requerido: true, categoria: 'sanitario' },
            { nombre: 'Póliza o Plan de Manejo de Residuos Sólidos y Líquidos', requerido: true, categoria: 'sanitario' }
        ];
        
        const documentosAlimentos = [
            { nombre: 'Certificado o Carné de Salud del Manipulador de Alimentos', requerido: true, categoria: 'personal' },
            { nombre: 'Certificado de Capacitación en Buenas Prácticas de Manufactura (BPM)', requerido: true, categoria: 'capacitacion' },
            ...
            { nombre: 'Plan de Saneamiento Básico', requerido: true, categoria: 'operativo' },
            { nombre: 'Manual o Protocolo de Limpieza y Desinfección', requerido: true, categoria: 'operativo' }
        ];
        
        const documentosOtros = [
            { nombre: 'Certificados de Aseo y Desinfección de Equipos', requerido: true, categoria: 'operativo' },
            { nombre: 'Certificados de Calibración de Equipos (si aplica)', requerido: false, categoria: 'equipos' },
    ...
    markNotificationReadById(id) {
        ...
        if (notification) {
            ...
            // Actualizar la sección de notificaciones si está activa
    ...
    renderTramitesWithPagination(tramites, type) {
        ...
        if (tramites.length === 0) {
            container.innerHTML = '<div class="empty-state"><div class="empty-state-icon"></div><h3>No se encontraron trámites</h3></div>';
    ...
    showDayVisits(dateStr) {
        ...
        if (visits.length === 0) {
            alert('No hay visitas programadas para este día');
        } else {
    ...
    renderChat(mensajes) {
        ...
        if (mensajes.length === 0) {
            container.innerHTML = '<p style="text-align: center; color: var(--gray-500); padding: 2rem;">No hay mensajes aún</p>';
            return;
        }
        
        container.innerHTML = mensajes.map(m => `
            <div class="message ${m.remitente === this.currentUser.email ? 'sent' : 'received'}">
                <div class="message-header">${m.remitente === this.currentUser.email ? 'Tú' : (m.remitente.includes('comercio') ? 'Comercio' : 'Inspector')}</div>
                <div>${m.texto}</div>
    ...
    sendMessage() {
        ...
        const otroUsuario = tramite.comercioId === this.currentUser.email 
            ? 'inspector@demo.com' 
            : tramite.comercioId;
        this.addNotification(`Nuevo mensaje en trámite ${tramite.id}`, 'info', tramite.id);
    },
    ...
    showDocumentsModal(tramiteId) {
        ...
        // Mostrar/ocultar sección de subida según el tipo de usuario
    ...
    renderDocuments(tramite) {
        ...
        // Agrupar documentos requeridos por categoría
        ...
        // Mostrar documentos requeridos organizados por categoría
                ...
                if (isInspector) {
                            ...
                            <div class="document-item-header">
                                <div class="document-item-info">
                                    <span class="checklist-icon">${documentoSubido ? 
                                        (estadoAprobacion === 'aprobado' ? '✓' : estadoAprobacion === 'rechazado' ? '✗' : '○') 
                                        : '○'}</span>
                                        ...
                                        <div style="margin-top: 0.5rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                            ...
                                            ${documentoSubido ? `
                                                <span style="font-size: 0.875rem; color: var(--gray-600);">
                                                    Subido: ${new Date(documentoSubido.fecha).toLocaleDateString('es-CO')} | ${documentoSubido.tamaño || 'N/A'}
                                                </span>
                                                ${estadoAprobacion !== 'pendiente' ? `
                                                    <span class="document-status ${estadoAprobacion}">
                                                        ${estadoAprobacion === 'aprobado' ? 'Aprobado' : 'Rechazado'}
                                                    </span>
                                                ` : '<span class="document-status pending">Pendiente de revisión</span>'}
                    ...
                    html += `
                        <div class="document-item-requerido ${documentoSubido ? 'completed' : ''}">
                            <div class="document-item-header">
                                <div class="document-item-info">
                                    <span class="checklist-icon">${documentoSubido ? '✓' : '○'}</span>
                                    <div style="flex: 1; margin-left: 0.75rem;">
                                        <strong>${doc.nombre}</strong>
                                        <div style="margin-top: 0.5rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                            ${doc.requerido ? '<span class="checklist-requerido">Requerido</span>' : '<span class="checklist-opcional">Opcional</span>'}
                                            <span class="checklist-categoria">${this.getCategoriaLabel(doc.categoria)}</span>
                                            ${documentoSubido ? `<span style="font-size: 0.875rem; color: var(--gray-600);">Subido: ${new Date(documentoSubido.fecha).toLocaleDateString('es-CO')} | ${documentoSubido.tamaño || 'N/A'}</span>` : ''}
                    ...
                    return `
                        <div class="document-item">
                            <div class="document-item-info">
                                ...
                                <div class="document-item-meta">Subido: ${new Date(doc.fecha).toLocaleString('es-CO')} | Tamaño: ${doc.tamaño || 'N/A'}</div>
                            </div>
    ...
    uploadDocumentForItem(tramiteId, documentoRequeridoId, file) {
        ...
        const tramite = this.tramites.find(t => t.id === tramiteId);
        if (!tramite) {
            this.showNotification('Error: Trámite no encontrado', 'error');
            return;
        }
    ...
    uploadDocument() {
        ...
        if (!this.currentTramiteDocuments) {
            this.showNotification('Error: No hay trámite seleccionado', 'error');
            return;
        }
    ...
    aprobarDocumento(tramiteId, documentoRequeridoId) {
        ...
        if (!documento) {
            this.showNotification('No se encontró el documento', 'error');
            return;
        }
    ...
    showMapModal(tramiteId) {
        ...
        // Usar Google Maps Embed sin API key (versión simplificada)
    ...
    getBoundingBox(direccion) {
        // Coordenadas aproximadas para Bogotá (ajustar según necesidad)
        // Esto es un placeholder, en producción se usaría geocodificación
    ...
    // Recordatorios
    checkReminders() {
        // Verificar recordatorios de visitas próximas
        const hoy = new Date();
        ...
        this.tramites.forEach(tramite => {
            tramite.historial.forEach(etapa => {
                if (etapa.fecha && etapa.etapa === 'Visita Programada') {
                    ...
                    if (fechaVisita >= hoy && fechaVisita <= mañana) {
                        this.addNotification(`Recordatorio: Visita programada para ${tramite.nombreComercio} mañana`, 'info', tramite.id);
                    }
                }
            });
        });
    ...
    setupNewEventListeners() {
        // Los botones de notificaciones ya están manejados en setupEventListeners para navegar a secciones
        
        
        // Los botones de navegación ya están manejados en setupEventListeners
